...
|---|---|---|
| `pytest` | 596 tests: lógica, agentes con cliente falso, contratos. Sin red | no |
...
| `cd web && npm test` | 115 tests del front: audio, micrófono, pizarra, hoja, mudez | no |
...
| Tests | **596** de Python + **115** del front, en verde. Lint en cero |
