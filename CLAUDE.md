...
|---|---|---|
| `pytest` | 666 tests: lógica, agentes con cliente falso, contratos. Sin red | no |
...
| `cd web && npm test` | 181 tests del front: audio, micrófono, cola del micrófono, pizarra, hoja, mudez | no |
...
| `python -m scripts.verificar_pizarra` | Qué le manda el tutor a la pizarra cuando el niño pide VER algo, cuánto tarda, y si se le escapa una palabra vetada | **sí** |
...
| Tests | **666** de Python + **181** del front, en verde. Lint en cero |
